...
export default function App() {
  ...
  async function realtyAction(type, realty) {
    let res;
    let body = {
      "actionType": type,
      "actionBody": {
  ...
  return (
    <>
      ...
      />
      <GameFields action={action} realtyAction={realtyAction} realtyes={realtyes} players={players} currentPlayer={currentPlayer}/>
